...
// @version      0.7
// @description  ZhangHaHa
// @author       define9
// @description  QQ:2066561288
	...
	window.onload = function(){
		...
		function signData(signUrl, stuId){
			...
			$.getJSON(signUrl,function(data){
				sign = btoa(data.rs.sign);
			})
			return sign;
		}
		function btnUrl(btnName,anUrl,stdID,sign){
			var endBtn = document.getElementById(btnName);

			var endURL = "http://39.103.140.188/url.php?msg=" + btoa(anUrl) + "&stuID=" + stdID + "&sign=" + sign;
		...
		$.getJSON(listUrl,function(data){
			...
			for(n=0;n<lenth;n++){
				...
				endUrl[n] = tempUrl[n] + "&forwardUrl=" + lxforwardUrl[n] + "&exerciseType=2&sign=";
				...
				var btnName = "lxx" + n;
				btnUrl(btnName,endUrl[n],studentId,sign[n]);
			}
		});
	};
})();